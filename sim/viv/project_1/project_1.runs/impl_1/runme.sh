...
HD_PWD='/home/a/0class/matches/DATA_CONVERT/0.21/sim/viv/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DATA_CONVERT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DATA_CONVERT.tcl -notrace
