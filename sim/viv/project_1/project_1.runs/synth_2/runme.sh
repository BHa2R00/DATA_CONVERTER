...
HD_PWD='/home/a/0class/matches/DATA_CONVERT/0.21/sim/viv/project_1/project_1.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log DATA_CONVERT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DATA_CONVERT.tcl
